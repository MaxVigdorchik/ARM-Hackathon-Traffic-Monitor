...
#define STDIO_UART                                        UART_1 // set by target:UBLOX_EVK_ODIN_W2
#define MBED_CONF_LWIP_USE_MBED_TRACE                     0      // set by library:lwip
#define MBED_CONF_TARGET_USB_TX                           D8     // set by target:UBLOX_EVK_ODIN_W2
...
#define MBED_CONF_TARGET_USB_RX                           D2     // set by target:UBLOX_EVK_ODIN_W2
